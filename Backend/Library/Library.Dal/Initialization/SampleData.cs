...
namespace Library.Dal.Initialization
{
    public static class SampleData
    {
        ...
        public static List<User> Users => new()
         {
            new() { Id = 1, Name = "Ahmed Yassin",Bio ="Co-Founder | Software Engineer | .NET Backend Developer ",BirthDate= new DateOnly(1999,12,28) ,ImageURL = "https://cdn-icons-png.flaticon.com/512/149/149071.png", ImagePath= "https://cdn-icons-png.flaticon.com/512/149/149071.png",Credit = 1000000000, Address = "Sharja, UAE",UserSex = Sex.Male, Email = "admin@admin.com", Phone = "+971567680570", UserRole = Role.Admin, PasswordHash = "$2b$10$TdH.ez4lF75n657iD0L6hOTppMFEFjvaKQMklrgZyDFevRPd0txfC" },
            new() { Id = 2, Name = "Mohammed Ismaiel",Bio ="Co-Founder | Software Engineer | React Frontend Developer ",BirthDate= new DateOnly(1999,11,10) ,ImageURL = "https://cdn-icons-png.flaticon.com/512/149/149071.png", ImagePath= "https://cdn-icons-png.flaticon.com/512/149/149071.png",Credit = 100, Address = "Dubai, UAE",UserSex = Sex.Male, Email = "moahmed@frontend.dev", Phone = "456-789-1234", UserRole = Role.Admin, PasswordHash = "$2b$10$TdH.ez4lF75n657iD0L6hOTppMFEFjvaKQMklrgZyDFevRPd0txfC" },
            new() { Id = 3, Name = "Musab Obada",Bio ="Co-Founder | Software Engineer | React Frontend Developer ",BirthDate= new DateOnly(2000,08,5) ,ImageURL = "https://cdn-icons-png.flaticon.com/512/149/149071.png", ImagePath= "https://cdn-icons-png.flaticon.com/512/149/149071.png",Credit = 50, Address = "Cairo, Egypt",UserSex = Sex.Male, Email = "mudab@frontend.dev", Phone = "789-123-4567", UserRole = Role.User, PasswordHash = "$2b$10$TdH.ez4lF75n657iD0L6hOTppMFEFjvaKQMklrgZyDFevRPd0txfC" },
            new() { Id = 4, Name = "Osman Elamin",ImageURL = "https://cdn-icons-png.flaticon.com/512/149/149071.png",BirthDate= new DateOnly(1996,5,6) , ImagePath= "https://cdn-icons-png.flaticon.com/512/149/149071.png",Credit = 30, Email = "user@user.com", Phone = "987-654-3210", UserRole = Role.User, PasswordHash = "$2b$10$2ZCWHccbE3OdeHuk2GelC.35KSbLXtlEE5Hx4eEO1NIPVvsAWV4ia" },
            new() { Id = 5, Name = "khojalei abbas",ImageURL = "https://cdn-icons-png.flaticon.com/512/149/149071.png",BirthDate= new DateOnly(1980,3,3) , ImagePath= "https://cdn-icons-png.flaticon.com/512/149/149071.png",Credit = 10, Email = "khojalei@example.com", Phone = "321-654-9870", UserRole = Role.User, PasswordHash = "$2b$10$2ZCWHccbE3OdeHuk2GelC.35KSbLXtlEE5Hx4eEO1NIPVvsAWV4ia" }
        };
