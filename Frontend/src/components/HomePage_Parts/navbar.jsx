    ...
    return (
        <>
            <nav className=" z-20 flex items-center justify-between bg-slate-100 sticky top-0 p-5">
                <NavLink className='flex items-center text-3xl font-bold text-orange-800' to='/home'>
                ...
                <div className=" hidden md:flex ms-8 justify-between items-center" >
                    ...
                    <ul className="flex w-44 grow items-center justify-evenly">
                        <li >
                            <Link to='/login'><button className="hover:underline hover:text-blue-800">log in</button></Link>
                        </li>
                        <li className="hover:underline">
                            <Link to='/register'><button className="hover:underline hover:underline-offset-1 hover:text-blue-800">Sign Up</button></Link>
                        </li>
                    </ul>
                </div>
            </nav>
            {/* <section className="mobile-menu text-4xl bg-slate-900 h-96 z-10 ">
